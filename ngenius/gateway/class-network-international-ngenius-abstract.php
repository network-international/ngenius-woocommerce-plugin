...
/**
 * Class NetworkInternationalNgeniusAbstract
 */
class NetworkInternationalNgeniusAbstract extends WC_Payment_Gateway
{
    /**
    ...
    public function __construct()
    {
        ...
        include_once dirname(__FILE__) . '/class-network-international-ngenius-settings.php';

        // Method with all the options fields
        $networkInternationalNgeniusSettings   = new NetworkInternationalNgeniusSettings();
        $this->form_fields = $networkInternationalNgeniusSettings->overrideFormFieldsVariable();
     ...
     */
    public function ngenius_void(WC_Order $order, NetworkInternationalNgeniusGatewayConfig $config, object $orderItem)
    {
        include_once dirname(__FILE__) . '/request/class-network-international-ngenius-gateway-request-void.php';
        include_once dirname(__FILE__) . '/http/class-network-international-ngenius-gateway-http-void.php';
        include_once dirname(__FILE__) . '/validator/class-network-international-ngenius-gateway-validator-void.php';

        $requestClass = new NetworkInternationalNgeniusGatewayRequestVoid($config);
        $requestHttp  = new NetworkInternationalNgeniusGatewayHttpVoid();
        $validator    = new NetworkInternationalNgeniusGatewayValidatorVoid();
    ...
    public function process_refund($order_id, $amount = null, $reason = '')
    {
        ...
        if (isset($amount) && $amount > 0) {
            include_once dirname(__FILE__) . '/request/class-network-international-ngenius-gateway-request-refund.php';
            include_once dirname(__FILE__) . '/http/class-network-international-ngenius-gateway-http-refund.php';
            include_once dirname(__FILE__) . '/validator/class-network-international-ngenius-gateway-validator-refund.php';
            include_once dirname(__FILE__) . '/class-network-international-ngenius-gateway-payment.php';
            ...
            $tokenClass = new NetworkInternationalNgeniusGatewayRequestToken($config);
    ...
    public function validateRefund($token, $config, $order, $orderItem, $amount): bool|array
    {
        if ($token) {
            ...
            $requestClass = new NetworkInternationalNgeniusGatewayRequestRefund($config);
            $requestHttp  = new NetworkInternationalNgeniusGatewayHttpRefund();
            $validator    = new NetworkInternationalNgeniusGatewayValidatorRefund();
